Technologies : PHP – MySQL – Bootstrap 5
  ...
  B. Espace Validateur (Chef hiérarchique)
      1. Consultation des demandes de son équipe.
      2. Validation ou rejet avec commentaire.
      3. Transmission automatique au niveau supérieur si nécessaire.
      4. Filtrage par statut / demandeur / date.
  C. Espace Administrateur
      1. Gestion des utilisateurs (CRUD).
      2. Gestion des types de besoins.
      3. Consultation de toutes les demandes.
      4. Affectation des demandes à un service (ex : achat, DSI...).
      5. Mise à jour des statuts (traitée, en cours...).
  ...
  Base de données : MySQL
    ...
    2. demandes (id, type, description, urgence, statut...)
    3. validation (id, demande_id, validateur_id, commentaire, date)
    4. types_besoins
    5. pieces_jointes
    5. Workflow du processus
    1. Demandeur crée une demande
    2. Système envoie au chef hiérarchique
    3. Chef valide / rejette
  4.
    o Si validée → envoyée à l’administrateur
    o Si rejetée → retour demandeur
  5. Administrateur traite la demande
  6. Demande marquée comme terminée
  7. Demandeur reçoit la notification
