                ...
                <form id="addTypeForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addTypeName"
                            placeholder="Ex: Matériel, Logiciel, Service..." required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Description</label>
                        <textarea class="form-control" id="addTypeDescription" rows="3"
                            placeholder="Décrivez ce type de besoin..."></textarea>
                    </div>
                </form>
            </div>
